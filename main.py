...
def start_game():
    canvas.fill(BLACK)
    canvas.blit(bk,(0,0))
    start_font1 = large_font.render("Welcome To Snake Game", True,GREEN,YELLOW)
    start_font2 = medium_font.render("Play Game", True, RED, BLUE)
    start_font3 = medium_font.render("Rules", True, RED, BLUE)
    start_font4 = medium_font.render("Quit", True, RED, BLUE)
    start_font5 = medium_font.render("Creator", True, RED, BLUE)
...
def creator():
    ...
    start_inst1 = large_font.render("Bikesh Kumar Shah", False, GREEN)
    start_inst1_rect = start_inst1.get_rect()
    start_inst1_rect.center = (WINDOW_WIDTH/2, 420)
    canvas.blit(start_inst1, start_inst1_rect)

    start_inst2 = medium_font.render("Hello Guys,It's me Bikesh Shah.", True, RED)
    start_inst3 = medium_font.render("My student id is 210261.", True, BLUE)
    start_inst4 = small_font.render("This is a simple game, developed using by python", True,GREEN)
...
def start_inst(start_font1, start_font1_rect):
            ...
            start_inst4 = medium_font.render("--> Give me your feedback", True, BLUE)
            start_inst5 = medium_font.render("<<BACK", True, RED, YELLOW)
            start_inst5_rect = start_inst5.get_rect()
